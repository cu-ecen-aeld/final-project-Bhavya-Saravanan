...
I created the S3 bucket, configured the permissions, and uploaded a sample firmware file.

I tested downloading the file from the bucket to make sure the Raspberry Pi will be able to access it later. The download worked correctly, so the server setup is confirmed.
...
Flash it to the alternate partition,

Update boot parameters,

And trigger a safe reboot.
...
![](<WhatsApp Image 2025-11-05 at 00.11.06_bfa6373c.jpg>)
Summary:
